...
import com.innvo.PentahorestApp;
...
@SpringBootTest(classes = PentahorestApp.class)
public class AssetResourceIntTest {
    ...
    private static final String DEFAULT_LASTMODIFEDBY = "AAAAAAAAAA";
    private static final String UPDATED_LASTMODIFEDBY = "BBBBBBBBBB";
    ...
    public static Asset createEntity(EntityManager em) {
        Asset asset = new Asset()
            ...
            .lastmodifedby(DEFAULT_LASTMODIFEDBY)
    ...
    public void createAsset() throws Exception {
        ...
        assertThat(testAsset.getLastmodifedby()).isEqualTo(DEFAULT_LASTMODIFEDBY);
    ...
    public void getAllAssets() throws Exception {
        ...
        restAssetMockMvc.perform(get("/api/assets?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].lastmodifedby").value(hasItem(DEFAULT_LASTMODIFEDBY.toString())))
    ...
    public void getAsset() throws Exception {
        ...
        restAssetMockMvc.perform(get("/api/assets/{id}", asset.getId()))
            ...
            .andExpect(jsonPath("$.lastmodifedby").value(DEFAULT_LASTMODIFEDBY.toString()))
    ...
    public void updateAsset() throws Exception {
        ...
        updatedAsset
            ...
            .lastmodifedby(UPDATED_LASTMODIFEDBY)
        ...
        assertThat(testAsset.getLastmodifedby()).isEqualTo(UPDATED_LASTMODIFEDBY);
